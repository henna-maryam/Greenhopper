    ...
    <div className="bg-[#1F2937] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow border border-[#5B8424]/20">
      ...
      <div className="p-6">
        <div className="flex justify-between items-center">
          ...
          <h3 className="text-2xl font-bold text-white mb-0">{pkg.title}</h3>
          <button
            onClick={() => onBookNow(pkg.title)}
            className="bg-[#5B8424] text-white px-4 py-2 rounded hover:bg-[#5B8424]/80 transition-colors ml-4"
          >
            Book Now
          </button>
        </div>
